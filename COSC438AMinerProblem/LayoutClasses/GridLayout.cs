...
namespace COSC438GameDesignNewREV
{
    ...
    {
        private Texture2D MinerSheet;
        private Texture2D EngineerSheet;
        private Texture2D ForemanSheet;       
        ...
        private List<StatusTile> statusTile;
        ...
        public List<PlayerTile> PlayerTile
        {
            get
            {
                return playerTile;
        ...
        public List<StatusTile> StatusTile
        {
            get
            {
                return statusTile;
            ...
            for (x = 0; x < tempArr.GetLength(1); x++)
            {
                for (y = 0; y < tempArr.GetLength(0); y++)
                {
                    switch (tempArr[y, x])
                    {
                        ...
                        case -77:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                        ...
                        case -80:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                ohmDropTile.Add(new OhmDropTile(4, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                break;
                            }
                        //Wire3
                        case -81:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                ohmDropTile.Add(new OhmDropTile(5, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                break;
                            }
                        case -82:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                ohmDropTile.Add(new OhmDropTile(6, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                break;
                            }
                        ...
                        case -101:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                ohmTile.Add(new OhmTile(-3, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj, x*SIZE,y*SIZE));
                                break;
                            }
                        case -86:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                ohmTile.Add(new OhmTile(2, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj, x * SIZE, y * SIZE));
                                break;
                            }
                        case -87:
                            {
                        ...
                        case -89:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                ohmTile.Add(new OhmTile(4, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj, x * SIZE, y * SIZE));
                                break;
                            }
                        case -90:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                ohmTile.Add(new OhmTile(5, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj, x * SIZE, y * SIZE));
                                break;
                            }
                        case -91:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                ohmTile.Add(new OhmTile(6, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj, x * SIZE, y * SIZE));
                                break;
                            }
                        case -92:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                ohmTile.Add(new OhmTile(7, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj, x * SIZE, y * SIZE));
                                break;
                            }
                        //Yellow Resistors
                        case -93:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                ohmTile.Add(new OhmTile(8, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj, x * SIZE, y * SIZE));
                                break;
                            }
                        case -94:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                ohmTile.Add(new OhmTile(9, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj, x * SIZE, y * SIZE));
                                break;
                            }
                        case -95:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                ohmTile.Add(new OhmTile(10, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj, x * SIZE, y * SIZE));
                                break;
                            }
                        case -96:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                ohmTile.Add(new OhmTile(11, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj, x * SIZE, y * SIZE));
                                break;
                            }
                        case -199:
                            {
                        ...
                        case -202:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                wireTile.Add(new WireTile(1, new Rectangle(x * SIZE, y * SIZE, 800, 120), gameObj));
                                break;
                            }
                        case -203:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                wireTile.Add(new WireTile(2, new Rectangle(x * SIZE, y * SIZE, 800, 120), gameObj));
                                break;
                            }
                        case -204:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                wireTile.Add(new WireTile(3, new Rectangle(x * SIZE, y * SIZE, 800, 120), gameObj));
                                break;
                            }                                            
                        case -212:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                statusTile.Add(new StatusTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                break;
                            }
                        case -213:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                statusTile.Add(new StatusTile(2, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                break;
                            }
                        case -214:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                statusTile.Add(new StatusTile(3, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                break;
                            }
                        case -215:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                guiTiles.Add(new PromptTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE * 2, SIZE), gameObj));
                                break;
                            }
                        case -216:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                guiTiles.Add(new PromptTile(2, new Rectangle(x * SIZE, y * SIZE, SIZE * 2, SIZE), gameObj));
                                break;
                            }
                        case -217:
                            {
                                backGroundTile.Add(new BackGroundTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                guiTiles.Add(new PromptTile(3, new Rectangle(x * SIZE, y * SIZE, SIZE * 2, SIZE), gameObj));
                                break;
                            }
                        case -218:
                            {
                                backGroundTile.Add(new BackGroundTile(0, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                               // guiTiles.Add(new PlayerTile(1, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE * 2), gameObj));
                                break;
                            }
                        case -219:
                            {
                                backGroundTile.Add(new BackGroundTile(0, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                               // guiTiles.Add(new PlayerTile(2, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE * 2), gameObj));
                                break;
                            }
                        case -220:
                            {
                                backGroundTile.Add(new BackGroundTile(0, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                              //  guiTiles.Add(new PlayerTile(3, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE * 2), gameObj));
                                break;
                            }                     
                        case -222:
                            {
                                backGroundTile.Add(new BackGroundTile(0, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                guiTiles.Add(new PromptTile(4, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                break;
                            }
                        case -223:
                            {
                                backGroundTile.Add(new BackGroundTile(0, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                guiTiles.Add(new ResourceTiles(4, new Rectangle(x * SIZE, y * SIZE, SIZE, SIZE), gameObj));
                                break;
                            }
                    }
                }
